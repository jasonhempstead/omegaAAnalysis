...
def build_root_hists(filename, histname,
    ...
    nonrand_spec = CaloSpectra.from_root_file(nonrand_file, nonrand_name,
                                              do_triple=True,
                                              single_param=True,
                                              param_guess=par_guess)
...
def main():
    ...
    dirs = ['clustersAndCoincidencesRand']
    ...
    for dir_name in dirs:
        ...
        uncorrected, corrected = build_root_hists(
            infile_name, nonrand_name=f'clustersAndCoincidences/clusters',
            nonrand_file=infile_name,
    ...
    outfile_name = infile_name.replace(
        '.root', '') + '_pileup_corrected_rand_fgain.root'
